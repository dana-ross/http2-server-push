...
class URLParseTest extends PHPUnit_Framework_TestCase {
    ...
    function test_http2_link_url_to_relative_path() {
        ...
        \WP_Mock::wpFunction( 'untrailingslashit', array( 'args' => array('http://www.example.com/1/2/3'), 'return' => '/1/2/3' ) );
        \WP_Mock::wpFunction( 'untrailingslashit', array( 'args' => array('http://www.example.com/1/2/3/'), 'return' => '/1/2/3' ) );
        \WP_Mock::wpFunction( 'untrailingslashit', array( 'args' => array('https://www.example.com/1/2/3'), 'return' => '/1/2/3' ) );
        \WP_Mock::wpFunction( 'untrailingslashit', array( 'args' => array('https://www.example.com/1/2/3/'), 'return' => '/1/2/3' ) );
